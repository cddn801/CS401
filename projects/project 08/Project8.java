...
// Project 8 - Writing Recursive Methods
// Cameron Nicholson
import java.io.*;
...
public class Project8
{
	...
	// given a number compute the number of 7's in that number // number = 713274772; //
	...
	{	
		if(n == 0) 
			return 0;
		if(n%10 == 8 && (n/10)%10 == 8)
			return count8s(n/10) + 2;
		if(n%10 == 8)
			return count8s(n/10) + 1;
		return count8s(n/10);
	}
